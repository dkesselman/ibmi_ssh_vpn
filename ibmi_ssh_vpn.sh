...
echo "c:\IBMi\plink -v -C $1@$HOST -P $REMOTEPORT -pw $2 -D 3128 -L $TELNETPORT:127.0.0.1:23 -L 449:127.0.0.1:449 -L 8470:127.0.0.1:8470 -L 8471:127.0.0.1:8471 -L 8472:127.0.0.1:8472 -L 8473:127.0.0.1:8473 -L 8474:127.0.0.1:8474 -L 8475:127.0.0.1:8475 -L 8476:127.0.0.1:8476" >> $HOMEPATH/IBMi/$1.cmd
